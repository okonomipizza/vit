...
import { SIDEBAR_WIDTH, SLIDESHOW_INTERVAL, TOPBAR_HEIGHT} from "./constants/layout.ts";
...
function ImageModal({
    ...
    const showControls = useModalControls(isSlideshow);
...
function App() {
    ...
    useSlideshow(isSlideshow, enlargedImageIndex, handleNextImage);
